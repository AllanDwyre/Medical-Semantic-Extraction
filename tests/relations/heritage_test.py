...
import unittest
from src.semantic_analysis.content_analyser import CauseExtractor,HeritageExtractor,  ContentAnalyzer, Relation
from src.utils.helper import load_nlp_model
from rich import print

class TestHeritageExtraction(unittest.TestCase):
	   
	def setUp(self):
		self.analyser = ContentAnalyzer(nlp_model= load_nlp_model(), extractors=[CauseExtractor(), HeritageExtractor()])
